...
ApplicationForm = connect(
  (state) => {
    ...
    // console.log(state.get('inSmileRegistrationPage').get('displayCongrats'));
    const displayCongrats = state.get('inSmileRegistrationPage').get('displayCongrats');
    const displayCongratsOnce = state.get('inSmileRegistrationPage').get('displayCongratsOnce');
    const displayEmailHint = state.get('inSmileRegistrationPage').get('displayEmailHint');
    const displayEmailHintOnce = state.get('inSmileRegistrationPage').get('displayEmailHintOnce');
    const displayPwFields = state.get('inSmileRegistrationPage').get('displayPwFields');
