...
//
// let ImmutableForm = class ImmutableForm extends React.Component {
// // const ImmutableForm = (props) => {
// //   componentDidMount() {
// //     this.props.initializeForm();
// //   }
//   render() {
//     const { classes, handleSubmit, reset, submitting, realSubmitting } = this.props;
//     return (
...
//               type="submit"
//               disabled={submitting || realSubmitting}
//             >
//               Submit
//             </Button>
...
// //   form: 'loanApplicationForm', // a unique identifier for this form
// //   validate,
// //   warn,
// // })(ImmutableForm));
//
...
//   (state) => ({
//     initialValues: state.get('data').toJS(), // pull initial values from account reducer
//   }),
